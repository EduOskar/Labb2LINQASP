...
namespace Labb2LINQ.Controllers
{
    public class TeachersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TeacherId,Title,FirstName,LastName")] Teacher teacher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TeacherId,Title,FirstName,LastName")] Teacher teacher)
        {
